...
(async()=>{
 if(process.env.APP_ORIGIN!=='http://127.0.0.1:8765')throw Error('This helper is restricted to the local Development environment. See STUDY-TIMER.md for production rollout.');
